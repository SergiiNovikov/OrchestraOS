...
def test_v1_llm_record_mock_then_replay_hit_e2e(tmp_path: Path) -> None:
    env_record = {
...
def test_v1_llm_record_without_provider_fail_closed_e2e(tmp_path: Path) -> None:
    env_bad = {
        "ORCHESTRA_ROLEPACK": "v1_llm",
        "LLM_MODE": "record",
        "LLM_CACHE_DIR": str(tmp_path),
...
def test_v1_llm_record_unknown_provider_fail_closed_e2e(tmp_path: Path) -> None:
    env_bad = {
        "ORCHESTRA_ROLEPACK": "v1_llm",
        "LLM_MODE": "record",
        "LLM_PROVIDER": "nope",
