...
def test_env_selects_v1_llm_and_produces_final_response() -> None:
    summary, output, runtime_error, manifest = _run_cli(
        "hello",
        env_overrides={"ORCHESTRA_ROLEPACK": "v1_llm"},
    )
...
def test_v1_llm_determinism_n3() -> None:
    s1, o1, e1, m1 = _run_cli("hello", env_overrides={"ORCHESTRA_ROLEPACK": "v1_llm"})
    s2, o2, e2, m2 = _run_cli("hello", env_overrides={"ORCHESTRA_ROLEPACK": "v1_llm"})
    s3, o3, e3, m3 = _run_cli("hello", env_overrides={"ORCHESTRA_ROLEPACK": "v1_llm"})
